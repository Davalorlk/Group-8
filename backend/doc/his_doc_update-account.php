<?php
	...
	include('assets/inc/config.php');
        ...
        if(isset($_POST['update_pwd']))
		{
            ...
            //sql to insert captured values
			$query="UPDATE his_docs SET doc_pwd =? WHERE doc_pwd = ?";
			$stmt = $mysqli->prepare($query);
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-centre mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-15"><strong>Employee Full Name :</strong> <span class="ml-2"><?php echo $row->doc_fname;?> <?php echo $row->doc_lname;?></span></p>
                                        <p class="text-muted mb-2 font-15"><strong>Employee Department :</strong> <span class="ml-2"><?php echo $row->doc_dept;?></span></p>
                                        <p class="text-muted mb-2 font-15"><strong>Employee Number :</strong> <span class="ml-2"><?php echo $row->doc_number;?></span></p>
                                        <p class="text-muted mb-2 font-15"><strong>Employee Email :</strong> <span class="ml-2"><?php echo $row->doc_email;?></span></p>
